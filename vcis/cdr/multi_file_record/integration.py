...
from vcis.cdr.multi_file_record.preproccess_funtions import CDR_Preproccess_fucntions
from vcis.cdr.multi_file_record.preprocess import CDR_Preproccess
...
class CDR_Integration():
    def __init__(self, verbose: bool = False):
        ...
        self.preproccess = CDR_Preproccess()
