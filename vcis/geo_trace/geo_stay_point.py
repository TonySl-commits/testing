...
class GeoStayPoint(GeoNode):
    def __init__(self, geo_node_id, latitude, longitude, start_timestamp, end_timestamp, osm_id=None, node_latitude=None, node_longitude=None, node_distance=0, geo_distance=0, next_node=None, previous_node=None, path=None):
